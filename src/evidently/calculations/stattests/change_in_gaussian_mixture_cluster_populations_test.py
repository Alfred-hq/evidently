...
def _get_three_gaussian_mixture_cluster_populations(series: pd.Series, n_components: int = 2):
    ...
    gaussian_mix_model = GaussianMixture(n_components=n_components)  
...
def _change_in_three_gaussian_mixture_cluster_populations_in_percentage_from_ref(
    ...
    max_cluster_populations_percentage_difference = np.max(cluster_populations_percentage_difference)
...
register_stattest(change_in_three_gaussian_mixture_cluster_populations_in_percentage_from_ref, _get_three_gaussian_mixture_cluster_populations)