...
def _value_within_twice_ref_iqr(
    ...
    """
    Compare the proportion of current data values within twice the IQR of reference data.
...
value_within_twice_iqr_stat_test = StatTest(
    name="value_within_twice_ref_iqr",
    display_name="Proportion of Values within Twice the Reference IQR",
    allowed_feature_types=[ColumnType.Numerical],
    default_threshold=0.9  
)

# Register the new test
register_stattest(value_within_twice_iqr_stat_test, _value_within_twice_ref_iqr)
